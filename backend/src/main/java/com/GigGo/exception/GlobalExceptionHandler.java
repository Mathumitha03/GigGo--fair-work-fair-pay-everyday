...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<String>> handleBadCredentials(BadCredentialsException ex) {
        ...
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                .body(ApiResponse.error("Invalid login credentials (check email/username/phone and password)"));
    }
    ...
    public ResponseEntity<ApiResponse<String>> handleUserNotFound(UsernameNotFoundException ex) {
        ...
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                .body(ApiResponse.error("Invalid login credentials"));
    }
    ...
    public ResponseEntity<ApiResponse<String>> handleAccessDenied(AccessDeniedException ex) {
        ...
        return ResponseEntity.status(HttpStatus.FORBIDDEN)
                .body(ApiResponse.error("Access denied: You do not have the required permissions for this action"));
    }
